...
config.General.requestName   = 'test_QCD_PU0to70_ALL'
...
config.Data.inputDataset = '/QCD_Pt-15to3000_TuneCP5_Flat_13TeV_pythia8/RunIIWinter17DR-NZSPU0to70_94X_upgrade2018_realistic_v8-v1/GEN-SIM-RAW'
config.Data.splitting = 'FileBased'
config.Data.unitsPerJob = 1
#config.Data.totalUnits = 5

#Change it to your directory
config.Data.outLFNDirBase = '/store/user/bchitrod/10X/QCD_PU0to70_ALL'
...
config.Data.outputDatasetTag = 'QCD_PU0to70_10X_JEC_ALL'
