...
config.General.requestName   = 'test_QCD_PU0to70_JRA_90'
...
config.Data.inputDataset = '/QCD_Pt-15to3000_TuneCP5_Flat_13TeV_pythia8/bchitrod-QCD_PU0to70_10X_JEC_ALL-6061c8cf151e4bbba4918201877e8b6e/USER'
config.Data.splitting = 'FileBased'
config.Data.unitsPerJob = 90
#config.Data.totalUnits = 10

#Change it to your directory
config.Data.outLFNDirBase = '/store/user/bchitrod/10X/QCD_PU0to70_JRA_90'
...
#config.Data.outputDatasetTag = 'QCD_PU0to70_92X_JEC_5'
